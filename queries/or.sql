...
SELECT FirstName, LastName FROM Customers WHERE NOT Address = '555 Elm St' OR City = 'Chicago';
...
SELECT OrderItemID, OrderID, Product FROM OrderItems WHERE NOT Quantity = 3 OR Price = 65;
...
SELECT OrderID, OrderDate FROM Orders WHERE NOT OrderDate = '2023-07-07' OR TotalAmount = 310;
...
SELECT ProductID, ProductName FROM Products WHERE NOT UnitPrice = 14.99 OR QuantityInStock = 60;