...
-- WHERE NOT
SELECT FirstName, LastName FROM Customers WHERE NOT City = 'Chicago';
SELECT Email FROM Customers WHERE NOT PostalCode = 90001;
...
SELECT OrderItemID, OrderID FROM OrderItems WHERE Price %2 <> 0;
-- WHERE NOT
SELECT OrderItemID, OrderID, Product FROM OrderItems WHERE NOT Quantity = 2;
SELECT OrderItemID, OrderID, Price FROM OrderItems WHERE NOT Price = 75;
...
SELECT OrderID, OrderDate FROM Orders WHERE TotalAmount %2 <> 0;
-- WHERE NOT
SELECT OrderID, OrderDate FROM Orders WHERE NOT TotalAmount = 180;
SELECT OrderID, OrderDate, TotalAmount FROM Orders WHERE NOT CustomerID = 1;
...
SELECT ProductID, ProductName FROM Products WHERE UnitPrice %2 <> 0;
-- WHERE NOT
SELECT ProductID, ProductName FROM Products WHERE NOT QuantityInStock = 100;
SELECT ProductID, ProductName, UnitPrice FROM Products WHERE NOT UnitPrice = 9.99;